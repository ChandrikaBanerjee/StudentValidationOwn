...
video {
  ...
  <li style="float:right"><a class="active" href="admin.jsp">ADMIN</a></li>
    ...
    <center>
    <body>
         <h1 style="color:blue;">SUPER USER</h1>
 ...
 USERNAME:<br>
  ...
  <br>
    ...
    <input type="Submit" name="Login1"  value="LOGIN" style="font-size:15pt;color:white;background-color:red;border:2px solid blueviolet;padding:3px">
