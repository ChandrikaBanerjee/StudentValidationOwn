...
<html>
    <head>
        ...
        <title>GO TO UPDATE COLLEGE</title>
    </head>
            <style>
...
video {
  ...
  <br>
    <input type="Submit" name="click"  value="GO TO UPDATE" style="font-size:15pt;color:white;background-color:red;border:2px solid blueviolet;padding:3px">
