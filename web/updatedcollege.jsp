        ...
        <h1>List of College</h1>
          <table cell padding="10" cell span="10" border="10" class="table table-box">
            <tr>
                ...
                <th style="width:200"> CLG_NAME</th>
                <th style="width:200"> UPDATE CLG NAME</th>
            </tr>
            <%ArrayList a=(ArrayList)request.getAttribute("Reportclg");
            String name1=""; 
            String id1="";
             String name2="";
             int i=0;
         ...
         {%>
            ...
            <input type="hidden" name="sizelist" value="<%=i%>" >
                      <button style="color:black" type="submit" name="Done" value="DONE">DONE</button>
            </form>       
